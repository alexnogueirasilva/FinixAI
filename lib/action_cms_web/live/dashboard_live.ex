        ...
        <div class="w-64 bg-gray-800 border-r border-gray-700 flex flex-col flex-shrink-0 min-w-0">
          ...
          <div class="p-6 border-b border-gray-700">
            <div class="flex items-center space-x-3">
              <div class="w-10 h-10 bg-gradient-to-r from-purple-400 to-pink-400 rounded-xl flex items-center justify-center floating-animation glow-effect">
            ...
            <ul class="space-y-3">
              <li>
                <a href="#" class="flex items-center space-x-3 p-3 rounded-lg bg-purple-600 text-white">
                  <.icon name="hero-home" class="w-5 h-5 flex-shrink-0" />
          ...
          <div class="p-6 border-t border-gray-700">
            <div class="flex items-center space-x-3">
              <div class="w-8 h-8 bg-gradient-to-r from-green-400 to-blue-400 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <.link href={~p"/users/log_out"} method="delete" class="text-gray-400 hover:text-white flex-shrink-0">
